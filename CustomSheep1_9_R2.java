...
public class CustomSheep1_9_R2 extends EntitySheep {

   public CustomSheep1_9_R2(CraftWorld world) {
   ...
   public static Sheep spawnSheep(Location loc) {
      ...
      CustomSheep1_9_R2 customEntity = new CustomSheep1_9_R2(mcWorld);
   ...
   private static void removeSounds(CustomSheep1_9_R2 customEntity) {
   ...
   private static void removeAI(CustomSheep1_9_R2 customEntity) {
      CraftSheep craftEntity = (CraftSheep)customEntity.getBukkitEntity();
      NBTTagCompound nbtTag = new NBTTagCompound();
      craftEntity.getHandle().c(nbtTag);
