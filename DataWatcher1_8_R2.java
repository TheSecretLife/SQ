...
public class DataWatcher1_8_R2 implements DataWatcher {
   ...
   public void extendTargetingRange(Sheep sheep, Location targetingLocation) {
      ...
      AttributeInstance attributes = ((EntityInsentient)((CraftEntity)sheep).getHandle()).getAttributeInstance(GenericAttributes.b);
