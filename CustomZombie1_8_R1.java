...
public class CustomZombie1_8_R1 extends EntityZombie {

   public CustomZombie1_8_R1(CraftWorld world) {
   ...
   public static Zombie spawnZombie(Location loc) {
      ...
      CustomZombie1_8_R1 customEntity = new CustomZombie1_8_R1(mcWorld);
      customEntity.setPosition(loc.getX(), loc.getY(), loc.getZ());
      customEntity.aI = loc.getYaw();
   ...
   private static void removeSounds(CustomZombie1_8_R1 customEntity) {
   ...
   private static void removeAI(CustomZombie1_8_R1 customEntity) {
      CraftZombie craftEntity = (CraftZombie)customEntity.getBukkitEntity();
      NBTTagCompound nbtTag = new NBTTagCompound();
      craftEntity.getHandle().c(nbtTag);
