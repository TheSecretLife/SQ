...
public class CustomZombie1_9_R2 extends EntityZombie {

   public CustomZombie1_9_R2(CraftWorld world) {
   ...
   public static Zombie spawnZombie(Location loc) {
      ...
      CustomZombie1_9_R2 customEntity = new CustomZombie1_9_R2(mcWorld);
   ...
   private static void removeSounds(CustomZombie1_9_R2 customEntity) {
   ...
   private static void removeAI(CustomZombie1_9_R2 customEntity) {
      CraftZombie craftEntity = (CraftZombie)customEntity.getBukkitEntity();
      NBTTagCompound nbtTag = new NBTTagCompound();
      craftEntity.getHandle().c(nbtTag);
