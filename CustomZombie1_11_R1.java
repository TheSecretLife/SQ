...
public class CustomZombie1_11_R1 extends EntityZombie {

   public CustomZombie1_11_R1(CraftWorld world) {
   ...
   public static Zombie spawnZombie(Location loc) {
      ...
      CustomZombie1_11_R1 customEntity = new CustomZombie1_11_R1(mcWorld);
      customEntity.setPosition(loc.getX(), loc.getY(), loc.getZ());
      customEntity.aP = loc.getYaw();
   ...
   private static void removeSounds(CustomZombie1_11_R1 customEntity) {
   ...
   private static void removeAI(CustomZombie1_11_R1 customEntity) {
      CraftZombie craftEntity = (CraftZombie)customEntity.getBukkitEntity();
      NBTTagCompound nbtTag = new NBTTagCompound();
      craftEntity.getHandle().c(nbtTag);
