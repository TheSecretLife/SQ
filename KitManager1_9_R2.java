...
public class KitManager1_9_R2 implements KitManager {
   ...
   public void giveKitItems(Player player, String arenaName) {
      ...
      if(arena != null) {
         ...
         ItemStack is1;
         ItemMeta im1;
         net.minecraft.server.v1_9_R2.ItemStack nmsIS1;
         NBTTagCompound tag1;
         ItemStack is2;
         ItemMeta im2;
         ItemStack is3;
         ...
         if(playerKit.equals("Archer")) {
            ...
            is2.setItemMeta(im2);
            net.minecraft.server.v1_9_R2.ItemStack is32 = CraftItemStack.asNMSCopy(is2);
   ...
   public void giveArmor(Player player, String arenaName) {
      ...
      is1.setItemMeta(im1);
      net.minecraft.server.v1_9_R2.ItemStack nmsIS1 = CraftItemStack.asNMSCopy(is1);
      ...
      is2.setItemMeta(im2);
      net.minecraft.server.v1_9_R2.ItemStack nmsIS2 = CraftItemStack.asNMSCopy(is2);
      ...
      is3.setItemMeta(im3);
      net.minecraft.server.v1_9_R2.ItemStack nmsIS3 = CraftItemStack.asNMSCopy(is3);
      ...
      is4.setItemMeta(im4);
      net.minecraft.server.v1_9_R2.ItemStack nmsIS4 = CraftItemStack.asNMSCopy(is4);
