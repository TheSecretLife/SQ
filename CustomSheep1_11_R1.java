...
public class CustomSheep1_11_R1 extends EntitySheep {

   public CustomSheep1_11_R1(CraftWorld world) {
   ...
   public static Sheep spawnSheep(Location loc) {
      ...
      CustomSheep1_11_R1 customEntity = new CustomSheep1_11_R1(mcWorld);
   ...
   private static void removeSounds(CustomSheep1_11_R1 customEntity) {
   ...
   private static void removeAI(CustomSheep1_11_R1 customEntity) {
      CraftSheep craftEntity = (CraftSheep)customEntity.getBukkitEntity();
      NBTTagCompound nbtTag = new NBTTagCompound();
      craftEntity.getHandle().c(nbtTag);
